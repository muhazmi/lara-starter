        ...
        <div class="modal-content">
            <form id="edit-category-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit-category_id">{{ __('Category') }}</label>
                        <select name="category_type_id" id="edit-category_type_id" class="form-control">
                            @foreach ($category_types as $categoryType)
                                <option value="{{ $categoryType->id }}">{{ $categoryType->name }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback" id="edit-category_type_id-error"></div>
                    </div>
                </div>
