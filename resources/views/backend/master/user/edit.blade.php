                            ...
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="identity_card_number"
                                        ...
                                        value="{{ old('identity_card_number', $users->identity_card_number) }}">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="mobile_phone" id="mobile_phone"
                                        value="{{ old('mobile_phone', $users->mobile_phone) }}">
                                </div>
                            </div>
                            <div class="col col-12 col-lg-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    @if (Storage::exists('assets/images/users/' . $users->photo))
                                        <p>
                                            <img src="{{ Storage::disk('images')->url('users/' . $users->photo) }}"
                        ...
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_id[]" id="role_id" required multiple>
