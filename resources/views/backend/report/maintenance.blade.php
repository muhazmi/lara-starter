...
@section('content')
    <div class="card">
        <form action="{{ route('reports.export_maintenances') }}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="product_id">{{ __('Choose Vehicle') }}</label>
                    <select name="product_id" id="product_id" class="form-control">
                        <option value="">{{ __('All Vehicles') }}</option>
                        @foreach ($products as $product)
                            <option value="{{ $product->id }}">{{ $product->license_plate . ' - '. $product->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
