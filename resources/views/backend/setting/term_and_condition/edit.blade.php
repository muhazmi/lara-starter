...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form id="form" action="{{ route('backend.terms_and_conditions.update') }}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ old('meta_description', $terms_and_conditions->meta_description) }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description">{{ __('Description') }}</label>
                            <textarea class="form-control" name="description" id="description">{{ old('description', $terms_and_conditions->description) }}</textarea>
                        </div>
                    </div>
