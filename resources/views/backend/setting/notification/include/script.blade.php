...
<script>
    $(document).ready(function() {
        ...
        $('#create-menu-form').off('submit').on('submit', function(e) {
            e.preventDefault();
            ...
            resetValidationErrors('#create-menu-form');
        ...
        $('#edit-menu-form').off('submit').on('submit', function(e) {
            e.preventDefault();
            ...
            // Remove previous error messages and classes
            resetValidationErrors('#edit-menu-form');

            let formData = new FormData(this);
            formData.append('_method', 'PUT'); // Ensure the method is set to PUT

            let url = '{{ route('menus.update', ':id') }}';
            let id = $('#edit-id').val();
        ...
        $('#createItemModal').on('hidden.bs.modal', function() {
            resetForm('#create-menu-form', '#create');
        });

        // Reset form fields and errors when edit modal is closed
        $('#editItemModal').on('hidden.bs.modal', function() {
            resetForm('#edit-menu-form', '#edit');
        });
    });
</script>
