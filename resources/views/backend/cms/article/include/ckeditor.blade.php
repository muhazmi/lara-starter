...
<script>
    const editorElements = [document.getElementById("description"), document.getElementById("package")];
    ...
    editorElements.forEach(element => {
        CKEDITOR.ClassicEditor.create(element, {
            ...
            // Be producteful with the setting below. It instructs CKEditor to accept ALL HTML markup.
            ...
            // Be producteful with enabling previews
            ...
            mention: {
                feeds: [{
                    ...
                    feed: [
                        ...
                        '@gingerbread',
                        '@gummi', '@ice', '@jelly-o',
                        '@liquorice', '@maproductoon', '@marzipan', '@oat', '@pie', '@plum',
                        '@pudding',
            ...
            removePlugins: [
                ...
                'Pagination',
                'WProofreader',
                // Producteful, with the Mathtype plugin CKEditor will not load when loading this sample
                // from a local file system (file://) - load this site via HTTP server if you enable MathType.
                'MathType',
                // The following features are part of the Carivity Pack and require additional license.
                'SlashCommand',
                'Template',
                'DocumentOutline',
                'FormatPainter',
