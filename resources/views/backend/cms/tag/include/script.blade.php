...
<script>
    $(document).ready(function() {
        ...
        // Ensure single event listener for create tag form submission
        $('#create-tag-form').off('submit').on('submit', function(e) {
            e.preventDefault();
            ...
            resetValidationErrors('#create-tag-form');

            let formData = new FormData(this);
            let url = '{{ route('tags.store') }}';
        ...
        // Ensure single event listener for edit tag form submission
        $('#edit-tag-form').off('submit').on('submit', function(e) {
            e.preventDefault();
            ...
            // Remove previous error messages and classes
            resetValidationErrors('#edit-tag-form');
